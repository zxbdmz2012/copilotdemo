...
/**
 * Condition class to check if global exceptionhandler handling is enabled.
...
public class OnGlobalExceptionHandlerCondition implements Condition {
     ...
     * if it is annotated with @EnableGlobalExceptionHandler. This determines whether global exceptionhandler
