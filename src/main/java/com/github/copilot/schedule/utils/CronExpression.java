...
public class CronExpression implements Serializable, Cloneable {
    ...
    protected void buildExpression(String expression) throws ParseException {
        ...
        try {
            ...
            throw new ParseException("Illegal cron expression format (" + var9 + ")", 0);
        }
    }
    ...
    public String getExpressionSummary() {
        String buf = "seconds: " +
                this.getExpressionSetSummary(this.seconds) +
                "\n" +
                "minutes: " +
                this.getExpressionSetSummary(this.minutes) +
                "\n" +
                "hours: " +
                this.getExpressionSetSummary(this.hours) +
                "\n" +
                "daysOfMonth: " +
                this.getExpressionSetSummary(this.daysOfMonth) +
                "\n" +
                "months: " +
                this.getExpressionSetSummary(this.months) +
                "\n" +
                "daysOfWeek: " +
                this.getExpressionSetSummary(this.daysOfWeek) +
                "\n" +
                "lastdayOfWeek: " +
                this.lastdayOfWeek +
                "\n" +
                ...
                "\n" +
                "years: " +
                this.getExpressionSetSummary(this.years) +
                "\n";
        return buf;
    }
